...
namespace ShenkinBagsStore.Controllers
{
    public class TransactionsController : Controller
    {
        private readonly MVCShenkinBagsStoreContext _context;

        public TransactionsController(MVCShenkinBagsStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var mVCShenkinBagsStoreContext = _context.Transactions.Include(t => t.Product).Include(t => t.User);
            return View(await mVCShenkinBagsStoreContext.ToListAsync());
        }
